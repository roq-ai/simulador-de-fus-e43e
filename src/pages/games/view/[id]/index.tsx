          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Difficulty Level" text={data?.difficulty_level} />

                <FormListItem label="Obstacles" text={data?.obstacles} />
                ...
                {hasAccess('desenvolvedora', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    ...
                    text={
                      <Link as={NextLink} href={`/desenvolvedoras/view/${data?.desenvolvedora?.id}`}>
                        {data?.desenvolvedora?.name}
                      </Link>
                    }
                  />
                )}
