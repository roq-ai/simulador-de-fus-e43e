...
export function GameListPage(props: GameListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'difficulty_level', header: 'difficulty_level', accessorKey: 'difficulty_level' },
    { id: 'obstacles', header: 'obstacles', accessorKey: 'obstacles' },
    hasAccess('desenvolvedora', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'desenvolvedora',
          header: 'Desenvolvedora',
          accessorKey: 'desenvolvedora',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/desenvolvedoras/view/${record.desenvolvedora?.id}`}
            >
              {record.desenvolvedora?.name}
            </Link>
          ),
        }
      : null,
